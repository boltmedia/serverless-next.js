...
const lambda_at_edge_1 = require("@contentco/lambda-at-edge");
const s3_static_assets_1 = __importDefault(
  require("@contentco/s3-static-assets")
);
const cloudfront_1 = __importDefault(require("@contentco/cloudfront"));
...
class NextjsComponent extends core_1.Component {
  ...
  deploy(inputs = {}) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (domain && subdomain) {
        const domainComponent = yield this.load("@contentco/domain");
