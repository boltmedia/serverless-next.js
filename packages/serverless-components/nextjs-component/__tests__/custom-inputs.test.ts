...
import { mockDomain } from "@contentco/domain";
import { mockS3 } from "@serverless/aws-s3";
import { mockUpload } from "aws-sdk";
import { mockLambda, mockLambdaPublish } from "@contentco/aws-lambda";
import { mockCloudFront } from "@contentco/aws-cloudfront";
...
describe("Custom inputs", () => {
  ...
  `("Custom domain", ({ inputDomains, expectedDomain }) => {
    ...
    it("uses @contentco/domain to provision custom domain", () => {
